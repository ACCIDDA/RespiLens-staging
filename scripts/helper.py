...
NHSN_COLUMN_MASKS = {
    "RAW_PATIENT_COUNTS": ['totalconfc19newadmadult', 
                         'jurisdiction',
                         'weekendingdate',
    ...
    "RAW_BED_CAPACITY": ['Number of Adult ICU Beds',
    ...
    "ABSOLUTE_PERCENT_CHANGE": ['Absolute Change in the Percent Hospitals Reporting  Influenza Admissions from Prior Week',
