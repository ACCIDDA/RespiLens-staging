...
import { IconChartLine, IconTarget, IconDashboard, IconSun, IconMoon, IconMenu2, IconBinaryTree } from '@tabler/icons-react';
...
const MainNavigation = () => {
  ...
  const navigationItems = [
    ...
    { href: '/documentation', label: 'Documentation', icon: IconBinaryTree, active: isActive('/documentation')}
  ];
