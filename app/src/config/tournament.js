...
export const TOURNAMENT_REGISTRY = [
  {
    ...
    enabled: true,
    path: "/cste",
    navLabel: "CsteWorkshop",
    storageKeyPrefix: "csteworkshop",
    name: "CSTE Forecastle challenge!",
    description:
      "Compete in 5 epidemic forecasting challenges and climb the leaderboard",
    // changed this in app/.env (add your constant)
    apiUrl:
      import.meta.env.VITE_ALLHANDS_CHALLENGE_API_URL ||
      "https://script.google.com/macros/s/AKfycbzqjk0MkNeASDo997e6z-ZPKiFv5wY2JRrto9e35Sboub4KdraZY8WkRbQTeIh92jdp/exec",
    sheetId: "1k4n1OYkO_4Eva4kqf6e3N8wZzSmyVy6x9BN0QASgFtU",
    features: {
